# -*- coding: utf-8 -*-
#
# Python 3 version - Blindspot -2022.01.08.
###################################################
# LOCAL import
###################################################
...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_HOSTS['moviesandseries'] = ['appletrailers', 'tv2play', 'efilmytv', 'ekinotv', 'cdapl', 'vizjerpl', 'zaluknijcc', 'filman', 'hdseanspl', 'ogladajto', 'govodtv', 'filmynadzis', 'horrorycc', 'filmowoclub', 'freediscpl',
                                                     ...
                                                     'filmpalast', 'hdstreams', 'serienstreamto', 'bsto', 'hdfilmetv', 'cineto', 'mozicsillag', 'wofvideo', 'rtlmost', 'gamatocom', 'xrysoise', 'gamatotvme', 'mooviecc', 'mrpiracy',
        ...
        self.PREDEFINED_HOSTS['german'] = ['youtube', 'streamstat', 'webstream', 'ardmediathek', 'zdfmediathek', 'artetv', 'tvnowde', 'spiegeltv', '7tvde', 'ddl', 'hdstreams', 'serienstreamto', 'bsto', 'hdfilmetv', 'cineto', 'filmpalast', 'kinox', 'szenestreamz', 'tata',
        ...
        self.PREDEFINED_HOSTS['hungarian'] = ['youtube', 'idokep', 'tv2play', 'onlinestream', 'wofvideo', 'localmedia', 'mozicsillag', 'webhuplayer', 'mediayou', 'updatehosts', 'nonstopmozi', 'mozicsillag', 'dmdamedia', 'filmpapa', 'filmvilag', 'filmtar', 'urllist', 'm4sport', 'mindigtv', 'streamstat', 'rtlmost', 'dailymotion', 'twitchtv']
        ...
        self.PREDEFINED_HOSTS['italian'] = ['youtube', 'streamstat', 'mediasetplay', 'filmpertutti', 'altadefinizione01', 'tantifilmorg', 'filmstreamhdit', 'dailymotion', 'vimeo', 'twitchtv', 'playrtsiw', 'altadefinizione', 'streaminghdfun', 'guardaserie', 'raiplay', 'dplayit']
        self.PREDEFINED_HOSTS['swedish'] = ['youtube', 'dailymotion', 'streamstat', 'vimeo', 'svtplayse', 'twitchtv']
        self.PREDEFINED_HOSTS['balkans'] = ['youtube', 'streamstat', 'andrijaiandjelka', 'filmehdnet', 'gledalica', 'filmativa', 'filmovizijastudio', 'filma24hdcom', 'filma24io', 'filmaoncom', 'serijeonline', 'filmeonlineto', 'fenixsite',
                                                     'dailymotion', 'vimeo', 'twitchtv']
        self.PREDEFINED_HOSTS['music'] = ['youtube', 'vevo', 'myfreemp3', 'musicmp3ru', 'dancetrippin', 'musicbox', 'vimeo', 'dailymotion', 'shoutcast', 'eskago', 'radiostacja', 'nuteczki', 'mediayou', 'streamstat']

        self.PREDEFINED_HOSTS['others'] = ['localmedia',  'updatehosts', 'streamstat', 'urllist', 'youtube', 'cdapl', 'wolnelekturypl', 'chomikuj', 'freediscpl', 'kabarety', 'spryciarze', 'wgrane', 'liveleak', 'dailymotion', 'vimeo', 'ted',
